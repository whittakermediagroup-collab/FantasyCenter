...
function PlayerAvatar({ player, teamLogos, size = 52 }) {
  ...
  return (
    <div className="rounded-full flex items-center justify-center display font-bold overflow-hidden relative"
      style={{ width: size, height: size, background: isDST ? "#0A100D" : c.bg, color: c.fg, border: `2px solid ${c.fg}`, boxShadow: "0 4px 10px -3px rgba(0,0,0,0.5)", fontSize: size * 0.34 }}>
      {showImage ? (
        <img
          src={src}
          alt={player.name}
            ...
            <div className="flex flex-col lg:flex-row lg:items-stretch gap-5">
              <div className="flex-1">
                <div className="flex items-center gap-3 flex-wrap">
                  <PlayerAvatar player={topPick.player} teamLogos={teamLogos} size={56} />
