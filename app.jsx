  ...
  return (
    <div style={{ background: "var(--bg)", color: "var(--text)", minHeight: "100%", fontFamily: "'Inter',sans-serif" }} className="w-full">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        ...
        {/* RECOMMENDATION HERO */}
        {topPick && (
          <div key={topPick.player.id} className="border p-5 sm:p-6 mb-6 glow hero-enter" style={{ background: "linear-gradient(135deg, var(--surface) 0%, var(--surface2) 100%)", borderColor: "rgba(124,227,139,0.3)", borderRadius: "var(--r-hero)" }}>
            <div className="flex items-center gap-2 mb-3">
...
function MyTeamPage({ lineupPlayers, myRoster, slotOptionsFor, currentSlotFor, moveToSlot, grade, starterVBDTotal }) {
  ...
  return (
    <div>
      ...
      {byeClashes.length > 0 && (
        <div className="rounded-xl border p-4 mb-6" style={{ background: "rgba(251,146,60,0.08)", borderColor: "rgba(251,146,60,0.4)" }}>
